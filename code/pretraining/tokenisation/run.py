...
if __name__ == '__main__':
    ...
    spm.SentencePieceTrainer.train(cmd) #starts training with cmd inputs --> produces two files: Glot500.model and Glot500.vocab
    # INFO: 
    # .vocab: saves the vocabulary (tokens) which the model knows
    # .model: is an extension of the .vocab file and additionally saves the rules for tokenization (model + vocab)

    #Load pretrained XLM-R SPM
    # load old and new vocabulary
    ...
    # save the raw, combined vocabulary
    ...
    # load and save in transformer format
