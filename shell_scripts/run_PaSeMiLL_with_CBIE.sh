...
jupyter nbconvert --to notebook --execute ../execution_notebooks/execute_PaSeMiLL_with_CBIE.ipynb --output ../execution_notebooks/execute_PaSeMiLL_with_CBIE_output.ipynb
