...
jupyter nbconvert --to notebook --execute ../execution_notebooks/execute_postprocessing_simalign_chap_5.2.ipynb --output ../execution_notebooks/execute_postprocessing_simalign_chap_5.2_output.ipynb
