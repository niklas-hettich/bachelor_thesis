...
jupyter nbconvert --to notebook --execute ../execution_notebooks/execute_postprocessing_simalign_chap_5.5.2_src_trg_stopword_filtering.ipynb --output ../execution_notebooks/execute_postprocessing_simalign_chap_5.5.2_src_trg_stopword_filtering_output.ipynb
