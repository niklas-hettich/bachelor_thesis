...
jupyter nbconvert --to notebook --execute ../execution_notebooks/execute_postprocessing_simalign_chap_5.5.1_no_subtraction.ipynb --output ../execution_notebooks/execute_postprocessing_simalign_chap_5.5.1_no_subtraction_output.ipynb
